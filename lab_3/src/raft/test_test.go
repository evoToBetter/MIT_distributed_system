...
func TestBackup2B(t *testing.T) {
	...
	log.Printf("%v %v", "Test (2B): leader backs up quickly over incorrect follower logs", "start")
	...
	cfg.one(rand.Int(), servers, true)
	log.Printf("%v %v", "Test (2B): leader backs up quickly over incorrect follower logs", "finished")
	cfg.end()
}
...
func TestUnreliableAgree2C(t *testing.T) {
	...
	log.Printf("%v %v", "Test (2C): unreliable agreement", "start")
	var wg sync.WaitGroup
	...
	log.Printf("%v %v", "Test (2C): unreliable agreement", "finished")
	cfg.end()
}
...
func TestFigure8Unreliable2C(t *testing.T) {
	...
	log.Printf("%v %v", "Test (2C): Figure 8 (unreliable)", "start")
	...
	log.Printf("%v %v", "Test (2C): Figure 8 (unreliable)", "finshed")
	cfg.end()
}
